            ...
            <div className="container-fluid p-0">
                ...
                <div className="exp" id="exp">
                    <div className="filter">
                        ...
                        <div className="resume-item text-start mt-5">
                            <h3 className="resume-title">General Assembly</h3>
                            ...
                            <p className="resume-desc fs-5">12-week long 500 hours full-time and full-stack web development program conducted in a remote setting, providing experience with the latest front- and back-end programming languages, tools, and methodologies including HTML, CSS, SASS, JavaScript, Node.JS, React.JS, MongoDB, Mongoose, SQL, Python, and Django.</p>
                        </div>



                        <div className="resume-item text-start mt-5">
                            <h3 className="resume-title">Great Ormond Street Hospital for Children</h3>
                            <h5 className="resume-subtitle">Postion: Web Application Developer</h5>
                            <p className="resume-date">2022 London, UK</p>
                            <p className="resume-desc fs-5">Conducted research on the impact of climate change on the distribution of invasive species in California. Used ArcGIS to analyze the spatial distribution of invasive species and climate data. Used R to analyze the correlation between the distribution of invasive species and climate change.</p>
                        </div>



                        <div className="resume-item text-start mt-5">
                            <h3 className="resume-title">Avanade</h3>
